...
exports.addMessage = exports.getMessage = exports.getMessages = void 0;
...
const addMessage = (username, text) => __awaiter(void 0, void 0, void 0, function* () {
    const { rows } = yield pool_1.default.query('INSERT INTO messages (username, text) VALUES ($1, $2)', [username, text]);
    return rows[0];
});
